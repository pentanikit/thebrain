...
@endif
    ...
    <section class="content-main align-items-center justify-content-center mt-5 my-5 py-5">
    <div class="card mx-auto card-login">
        <div class="card-body">
            <h4 class="card-title mb-4">Sign in</h4>
            <small>The Brain Admin Panel</small>
            {{-- Login form --}}
            <form method="POST" action="{{ route('loginroute') }}">
                ...
                <div class="mb-3 d-flex justify-content-between align-items-center">
                    <a class="float-end font-sm text-muted"
                       href="#">
                        Forgot password?
                    </a>
            ...
            {{-- Optional: social logins (can be wired later) --}}
